<template>
  ...
  >
    ...
    <div id="detailcontent" v-if="!!articMessage">
        ...
        <div id="operate" v-if="hidshow">
          ...
          <div class="agreeuthor" @click="agreeAuthors();">
            <span
              class="authorimg"
              :class="
                articMessage.isClick ? 'agreeauthorimged' : 'agreeauthorimg'
              "
            >
            </span>
            <span class="agreeaunum">{{ articMessage.clicknum }}</span>
          </div>
          <div class="cmauthor">
            <span class="cmauthorimg authorimg"></span>
            <span class="agreeaunum">{{ articMessage.commentnum }}</span>
          </div>
        </div>
